...
import { Button, Modal, FormGroup, ControlLabel, ListGroupItem } from 'react-bootstrap';
          ...
          <Modal.Body>
            ...
            </FormGroup>
            {
              this.state.answered
                &&
                  (this.state.correct
                    ? <ListGroupItem bsStyle="success">{this.props.correct_answer_text}</ListGroupItem>
                    : <ListGroupItem bsStyle="danger">{this.props.incorrect_answer_text}</ListGroupItem>)
            }
          </Modal.Body>
          <Modal.Footer>
            {
